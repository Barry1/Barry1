...
\newglossaryentry{JREAP-C}%
{%
	name=JREAP-C,%
	description={JREAP-C (Joint Range Extension Applications Protocol C) ist ein militärisches NATO-Standardprotokoll (STANAG 5518), %
		das entwickelt wurde, um taktische Daten, insbesondere Link-16-Nachrichten, über standardmäßige IP-Netzwerke wie TCP/IP zu übertragen. %
		Es ermöglicht Systemen den weltweiten Informationsaustausch über weite Entfernungen, ohne auf direkte Sichtverbindung angewiesen zu sein. %
		Einige Informationen sind \href{https://marineforum.online/link-22-fuer-f124-kurs-marine-2025/}{hier} bzw.\ \href{https://archive.ph/a5Oef}{hier} zu finden}%
}
...
\newglossaryentry{Marineunterstützungskommando}%
{%
	name=Marineunterstützungskommando,%
	description={Das Marineunterstützungskommando (MUKdo) verantwortet den sicheren Betrieb und die materielle Einsatzfähigkeit der Systeme der Deutschen Marine %
	    – im Normalbetrieb und Manövern wie im Einsatz. Es sorgt technisch und logistisch für Schiffe und Boote, Flugzeuge und Hubschrauber sowie Landanlagen und übrige Ausrüstung der Flotte. %
		Das heißt, die militärischen und zivilen Ingenieure des Kommandos kümmern sich um die Fregatten der Einsatzflottille 2 ebenso wie um die Munition des Marinefliegergeschwaders 5 %
		oder die Brückensimulatoren an der Marineoperationsschule. Sie stellen das einwandfreie Funktionieren eines Kriegsschiffs als komplexes Waffensystem und Netzwerk sicher, %
		von einer Operationszentrale aus gesteuert. %
		Das schließt die Rechneranlagen des Führungs- und Waffeneinsatzsystems, FüWES genannt, sowie die Datenverbindungen innerhalb des Schiffes und zu anderen Plattformen ein. %
		Weitere Details sind \href{https://www.bundeswehr.de/de/organisation/marine/struktur/marineunterstuetzungskommando}{hier} zu finden}%
}
...
\newglossaryentry{The rule of Thirds}%
{%
	name=The rule of Thirds,%
	description={The \dots{} is a military planning guideline that divides a naval fleet into three equal parts to balance active missions, crew training, and ship maintenance.%
	Following \href{https://www.navylookout.com/minister-tells-head-of-the-royal-navy-to-make-increasing-warship-availability-a-priority/}{the Royal Navy's minister's directive}, %
	resulting in those three Phases: %
	Operations (One-Third): Ships are deployed on active patrols, combat missions, or kept at high readiness for immediate tasking. %
	Preparation (One-Third): Crews go through training, certifications, and work-ups to get ready for their next deployment. %
	Maintenance (One-Third): Vessels sit in shipyards for deep repairs, refits, or overhauls%
	}%
}
