...
# ln /home/ebeling/GitHub/Barry1/shell_helpers/pdfoptprinter.sh ~/.local/bin/pdfoptprinter.sh
...
gs \
	-dNOPAUSE -dBATCH -sDEVICE=pdfwrite -dCompatibilityLevel=1.7 -dPDFSETTINGS=/printer -sOutputFile="${1%.pdf}_opt_printer.pdf" \
	"$1"
